...
#define USER_Q_IO          2	/* ready users_io are scheduled via queue 2 */
#define USER_Q_CALC        3	/* ready users_calc are scheduled via queue 3 */
#define USER_Q_INTER       4	/* ready users_inter are scheduled via queue 4 */

...
#define USER_PROC_GROUP_IO    0
#define USER_PROC_GROUP_CALC  1
#define USER_PROC_GROUP_INTER 2
#define USER_PROC_GROUP_COUNT 3
...
EXTERN int counter_io;
EXTERN int counter_calc;
EXTERN int counter_inter;
EXTERN int a;
